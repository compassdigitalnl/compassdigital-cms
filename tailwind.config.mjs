    ...
    extend: {
      ...
      colors: {
        ...
        blue: {
          ...
          100: 'color-mix(in srgb, var(--color-info, #00897B) 15%, white)',
          200: 'color-mix(in srgb, var(--color-info, #00897B) 30%, white)',
          300: 'color-mix(in srgb, var(--color-info, #00897B) 50%, white)',
          400: 'color-mix(in srgb, var(--color-info, #00897B) 75%, white)',
          500: withOpacity('--color-info-rgb'),
          600: 'color-mix(in srgb, var(--color-info, #00897B) 88%, black)',
          700: 'color-mix(in srgb, var(--color-info, #00897B) 75%, black)',
          800: 'color-mix(in srgb, var(--color-info, #00897B) 60%, black)',
        ...
        green: {
          ...
          100: 'color-mix(in srgb, var(--color-success, #00C853) 15%, white)',
          200: 'color-mix(in srgb, var(--color-success, #00C853) 30%, white)',
          300: 'color-mix(in srgb, var(--color-success, #00C853) 50%, white)',
          400: 'color-mix(in srgb, var(--color-success, #00C853) 75%, white)',
          500: withOpacity('--color-success-rgb'),
          600: 'color-mix(in srgb, var(--color-success, #00C853) 88%, black)',
          700: 'color-mix(in srgb, var(--color-success, #00C853) 75%, black)',
          800: 'color-mix(in srgb, var(--color-success, #00C853) 60%, black)',
          900: 'var(--color-success-dark, #1B5E20)',
        },

        // ─── Semantic: Warning (amber/yellow/orange) ────────────────────
        amber: {
          DEFAULT: withOpacity('--color-warning-rgb'),
          light: withOpacity('--color-warning-light-rgb'),
          50: withOpacity('--color-warning-light-rgb'),
          100: 'color-mix(in srgb, var(--color-warning, #F59E0B) 15%, white)',
          200: 'color-mix(in srgb, var(--color-warning, #F59E0B) 30%, white)',
          300: 'color-mix(in srgb, var(--color-warning, #F59E0B) 50%, white)',
          400: 'color-mix(in srgb, var(--color-warning, #F59E0B) 75%, white)',
          500: withOpacity('--color-warning-rgb'),
          600: 'color-mix(in srgb, var(--color-warning, #F59E0B) 88%, black)',
          700: 'color-mix(in srgb, var(--color-warning, #F59E0B) 75%, black)',
          800: 'color-mix(in srgb, var(--color-warning, #F59E0B) 60%, black)',
        ...
        coral: {
          ...
          100: 'color-mix(in srgb, var(--color-error, #EF4444) 15%, white)',
          200: 'color-mix(in srgb, var(--color-error, #EF4444) 30%, white)',
          300: 'color-mix(in srgb, var(--color-error, #EF4444) 50%, white)',
          400: 'color-mix(in srgb, var(--color-error, #EF4444) 75%, white)',
          500: withOpacity('--color-error-rgb'),
          600: 'color-mix(in srgb, var(--color-error, #EF4444) 88%, black)',
          700: 'color-mix(in srgb, var(--color-error, #EF4444) 75%, black)',
          800: 'color-mix(in srgb, var(--color-error, #EF4444) 60%, black)',
          900: 'var(--color-error-dark, #991B1B)',
        },

        // ─── Override default Tailwind red → theme error ────────────────
        red: {
          50: 'color-mix(in srgb, var(--color-error, #EF4444) 8%, white)',
          100: 'color-mix(in srgb, var(--color-error, #EF4444) 15%, white)',
          200: 'color-mix(in srgb, var(--color-error, #EF4444) 30%, white)',
          300: 'color-mix(in srgb, var(--color-error, #EF4444) 50%, white)',
          400: 'color-mix(in srgb, var(--color-error, #EF4444) 75%, white)',
        ...
        // ─── Override default Tailwind yellow → theme warning ────────────
        yellow: {
          50: withOpacity('--color-warning-light-rgb'),
          100: 'color-mix(in srgb, var(--color-warning, #F59E0B) 15%, white)',
          200: 'color-mix(in srgb, var(--color-warning, #F59E0B) 30%, white)',
        ...
        // ─── Override default Tailwind orange → theme warning ───────────
        orange: {
          50: withOpacity('--color-warning-light-rgb'),
          100: 'color-mix(in srgb, var(--color-warning, #F59E0B) 15%, white)',
          200: 'color-mix(in srgb, var(--color-warning, #F59E0B) 30%, white)',
        ...
        // ─── Override default Tailwind emerald → theme success ──────────
        emerald: {
          50: withOpacity('--color-success-light-rgb'),
          100: 'color-mix(in srgb, var(--color-success, #00C853) 15%, white)',
          200: 'color-mix(in srgb, var(--color-success, #00C853) 30%, white)',
        ...
        // ─── Override default Tailwind pink → theme error ───────────────
        pink: {
          50: 'color-mix(in srgb, var(--color-error, #EF4444) 8%, white)',
          100: 'color-mix(in srgb, var(--color-error, #EF4444) 15%, white)',
          200: 'color-mix(in srgb, var(--color-error, #EF4444) 30%, white)',
        ...
        // ─── Override default Tailwind purple/violet/indigo → theme primary ─
        purple: {
          50: 'color-mix(in srgb, var(--color-primary, #00897B) 8%, white)',
          100: 'color-mix(in srgb, var(--color-primary, #00897B) 15%, white)',
          200: 'color-mix(in srgb, var(--color-primary, #00897B) 30%, white)',
        ...
        // ─── Override default Tailwind gray → theme greys ───────────────
        gray: {
          50: 'var(--color-grey-light, #F1F4F8)',
          100: 'var(--color-grey-light, #F1F4F8)',
          200: 'color-mix(in srgb, var(--color-grey-light, #F1F4F8) 90%, var(--color-grey-mid, #94A3B8))',
          300: 'color-mix(in srgb, var(--color-grey-mid, #94A3B8) 40%, var(--color-grey-light, #F1F4F8))',
          400: withOpacity('--color-grey-mid-rgb'),
          500: withOpacity('--color-grey-dark-rgb'),
          600: withOpacity('--color-grey-dark-rgb'),
          700: 'color-mix(in srgb, var(--color-grey-dark, #64748B) 85%, var(--color-secondary, #0A1628))',
          800: 'color-mix(in srgb, var(--color-secondary, #0A1628) 80%, var(--color-grey-dark, #64748B))',
          900: 'var(--color-secondary, #0A1628)',
        },

        // ─── Override default Tailwind slate → theme greys ──────────────
        slate: {
          50: 'var(--color-grey-light, #F1F4F8)',
          100: 'var(--color-grey-light, #F1F4F8)',
          200: 'color-mix(in srgb, var(--color-grey-light, #F1F4F8) 90%, var(--color-grey-mid, #94A3B8))',
