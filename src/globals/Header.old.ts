  ...
  fields: [
    {
      type: 'tabs',
      tabs: [
        // ─── TAB 0: LAYOUT & STRUCTURE ────────────────────────────
        {
          label: 'Layout & Structuur',
          description: 'Kies de header layout en toon/verberg hoofdcomponenten',
          fields: [
            {
              name: 'layoutType',
              type: 'select',
              ...
              options: [
                {
                  label: 'Mega Navigation (c14-meganav style - volledig)',
                  value: 'mega-nav',
                },
                {
                ...
                {
                  label: 'Minimal (alleen logo + acties)',
                  value: 'minimal',
                },
              ],
              admin: {
                description:
                  'Kies de basis header layout. Mega Nav is ideaal voor webshops met veel categorieën, Single Row voor eenvoudige sites, Minimal voor landing pages.',
              },
            },
            {
              name: 'showTopbar',
              type: 'checkbox',
              label: 'Toon Topbar (USP berichten)',
              defaultValue: true,
              admin: {
                description:
                  'Schakel de topbar in/uit (bevat USP berichten boven de header). Je kunt de inhoud configureren in de "TopBar USPs" tab.',
              },
            },
            {
              name: 'showSearchBar',
              ...
              admin: {
                description:
                  'Schakel de zoekbalk in/uit. Op mobile wordt dit altijd een search icon die een overlay opent.',
            ...
            },
            {
              ...
              admin: {
                description:
                  'Schakel de hoofdnavigatie in/uit. Je kunt de navigatie configureren in de "Navigatie Menu" tab.',
                condition: (data) => data.layoutType !== 'minimal',
              },
            },
          ],
          ...
          fields: [
            {
              ...
              fields: [
                ...
                // ── Language Switcher ──
                {
                  ...
                  admin: {
                    description:
                      'Toon een taalwisselaar in de topbar (rechts). Let op: Je moet ook de talen configureren hieronder.',
                    condition: (data, siblingData) => siblingData?.enabled === true,
                  },
                },
                {
                  ...
                  admin: {
                    description:
                      'Configureer de beschikbare talen. Bij 2-3 talen worden knoppen getoond, bij 4+ een dropdown.',
                    condition: (data, siblingData) =>
                      siblingData?.enabled === true && siblingData?.enableLanguageSwitcher === true,
                  },
                  fields: [
                    {
                      name: 'code',
                      ...
                      admin: {
                        placeholder: 'NL',
                        description: 'Hoofdletters aanbevolen (NL, EN, DE, FR)',
                      },
                    },
                    {
                      name: 'label',
                      ...
                      admin: {
                        ...
                        description: 'Volledige taalnaam',
                      },
                    },
                    {
                      name: 'flag',
                      type: 'text',
                      label: 'Vlag Emoji (optioneel)',
                      admin: {
                        placeholder: '🇳🇱',
                        description: 'Emoji vlag voor visuele weergave',
                      },
                    },
                    {
                      name: 'isDefault',
                      ...
                      defaultValue: false,
                      admin: {
                        description: 'Is dit de standaard taal? (slechts 1 taal kan default zijn)',
                      },
                    },
                  ],
                },
                ...
                // ── Price Toggle (B2B/B2C) ──
                {
                  ...
                  admin: {
                    description:
                      'Toon een B2B/B2C prijs wisselaar in de topbar (rechts). Gebruikers kunnen schakelen tussen particuliere en zakelijke prijzen.',
                    condition: (data, siblingData) => siblingData?.enabled === true,
                  },
                },
                {
                  name: 'priceToggleSettings',
                  type: 'group',
                  label: 'Prijs Wisselaar Instellingen',
                  admin: {
                    description: 'Configureer de labels en standaard modus',
                    condition: (data, siblingData) =>
                      siblingData?.enabled === true && siblingData?.enablePriceToggle === true,
                  },
                  fields: [
                    {
                      name: 'defaultMode',
