...
export const DEFAULT_SETTINGS = {
  ...
  filterableFields: {
    products: ['brand', 'brandId', 'brandLevel', 'manufacturer', 'productLine', 'categories', 'categoryIds', 'price', 'effectivePrice', 'stock', 'stockStatus', 'status', 'featured', 'badge', 'productType', 'backordersAllowed', 'specs', 'hideFromCatalog'] as string[],
