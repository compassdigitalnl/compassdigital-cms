  ...
  return (
    <div className="flex items-start gap-2">
      ...
      <select
        ...
        className="w-44 shrink-0 rounded border border-gray-300 bg-white px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
      >
        {groups.map((group) => (
      ...
      <select
        ...
        className="w-40 shrink-0 rounded border border-gray-300 bg-white px-3 py-2 text-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
      >
      ...
      <button
        type="button"
        onClick={onDelete}
        className="shrink-0 rounded p-2 text-gray-400 transition-colors hover:bg-red-50 hover:text-red-500"
