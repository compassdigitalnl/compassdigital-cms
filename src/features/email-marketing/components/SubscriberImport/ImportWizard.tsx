...
export function ImportWizard({
  ...
  return (
    <div className={`max-w-2xl mx-auto ${className}`}>
      ...
      {error && (
        <div className="p-3 mb-4 rounded-lg text-sm bg-coral-50 border border-coral/20 text-coral">
          {error}
        </div>
      )}
        ...
        <div className="text-center py-6">
          ...
          {result.errors.length > 0 && (
            <details className="text-left mb-4 max-h-40 overflow-y-auto">
              <summary className="text-xs text-coral cursor-pointer font-medium">
