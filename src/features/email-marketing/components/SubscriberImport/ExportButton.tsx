...
export function ExportButton({ status, list, className = '' }: ExportButtonProps) {
  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-bold border border-gray-300 text-gray-700 hover:bg-gray-50 disabled:opacity-50 transition-all ${className}`}
    >
