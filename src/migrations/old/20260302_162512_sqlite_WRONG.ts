...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  await db.run(sql`CREATE TABLE \`cookie_consents\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`cookie_consents_session_id_idx\` ON \`cookie_consents\` (\`session_id\`);`)
  await db.run(sql`CREATE INDEX \`cookie_consents_updated_at_idx\` ON \`cookie_consents\` (\`updated_at\`);`)
  await db.run(sql`CREATE INDEX \`cookie_consents_created_at_idx\` ON \`cookie_consents\` (\`created_at\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`customers_customer_group_idx\` ON \`customers\` (\`customer_group_id\`);`)
  await db.run(sql`CREATE INDEX \`customers_approved_by_idx\` ON \`customers\` (\`approved_by_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`carts_coupons\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  	\`code\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`carts_coupons_order_idx\` ON \`carts_coupons\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`carts_coupons_parent_id_idx\` ON \`carts_coupons\` (\`_parent_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`carts_customer_group_idx\` ON \`carts\` (\`customer_group_id\`);`)
  await db.run(sql`CREATE INDEX \`carts_converted_to_order_idx\` ON \`carts\` (\`converted_to_order_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`orders_texts\` (
  	\`id\` integer PRIMARY KEY NOT NULL,
  	\`order\` integer NOT NULL,
  	\`parent_id\` integer NOT NULL,
  	\`path\` text NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`orders_texts_order_parent\` ON \`orders_texts\` (\`order\`,\`parent_id\`);`)
  ...
  `)
  await db.run(sql`CREATE INDEX \`stock_reservations_product_idx\` ON \`stock_reservations\` (\`product_id\`);`)
  await db.run(sql`CREATE INDEX \`stock_reservations_cart_id_idx\` ON \`stock_reservations\` (\`cart_id\`);`)
  await db.run(sql`CREATE INDEX \`stock_reservations_session_idx\` ON \`stock_reservations\` (\`session\`);`)
  await db.run(sql`CREATE INDEX \`stock_reservations_status_idx\` ON \`stock_reservations\` (\`status\`);`)
  await db.run(sql`CREATE INDEX \`stock_reservations_expires_at_idx\` ON \`stock_reservations\` (\`expires_at\`);`)
  await db.run(sql`CREATE INDEX \`stock_reservations_converted_to_order_idx\` ON \`stock_reservations\` (\`converted_to_order_id\`);`)
  ...
  await db.run(sql`CREATE INDEX \`payload_locked_documents_rels_cookie_consents_id_idx\` ON \`payload_locked_documents_rels\` (\`cookie_consents_id\`);`)
  ...
  await db.run(sql`CREATE TABLE \`settings_shop_filter_order\` (
  	\`_order\` integer NOT NULL,
  	\`_parent_id\` integer NOT NULL,
  	\`id\` text PRIMARY KEY NOT NULL,
  ...
  `)
  await db.run(sql`CREATE INDEX \`settings_shop_filter_order_order_idx\` ON \`settings_shop_filter_order\` (\`_order\`);`)
  await db.run(sql`CREATE INDEX \`settings_shop_filter_order_parent_id_idx\` ON \`settings_shop_filter_order\` (\`_parent_id\`);`)
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  await db.run(sql`DROP TABLE \`cookie_consents\`;`)
  ...
  await db.run(sql`DROP TABLE \`stock_reservations\`;`)
  ...
  await db.run(sql`DROP TABLE \`settings_shop_filter_order\`;`)
