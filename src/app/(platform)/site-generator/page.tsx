...
import { WizardStep1Company } from '@/features/platform/components/site-generator/WizardStep1Company'
import { WizardStep2Goal } from '@/features/platform/components/site-generator/WizardStep2Goal'
import { WizardStep3Content } from '@/features/platform/components/site-generator/WizardStep3Content'
import { WizardStep2Design } from '@/features/platform/components/site-generator/WizardStep2Design'
import { WizardStepServices } from '@/features/platform/components/site-generator/WizardStepServices'
import { WizardStepTestimonials } from '@/features/platform/components/site-generator/WizardStepTestimonials'
import { WizardStepPortfolio } from '@/features/platform/components/site-generator/WizardStepPortfolio'
import { WizardStepPricing } from '@/features/platform/components/site-generator/WizardStepPricing'
import { WizardStepContact } from '@/features/platform/components/site-generator/WizardStepContact'
import { WizardStep4Features } from '@/features/platform/components/site-generator/WizardStep4Features'
import { WizardStepEcommerce } from '@/features/platform/components/site-generator/WizardStepEcommerce'
import { WizardStepProductImport } from '@/features/platform/components/site-generator/WizardStepProductImport'
import { WizardStep5Generate } from '@/features/platform/components/site-generator/WizardStep5Generate'
