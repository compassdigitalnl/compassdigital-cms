...
import { LivePreviewListener } from '@/branches/shared/components/providers/LivePreviewListener'
import { Providers } from '@/providers'
import { ThemeProvider } from '@/branches/shared/components/providers/ThemeProvider'
...
import { ToastProvider } from '@/branches/shared/components/ui/feedback/ToastSystem'
...
/**
 * Professional Services Branch Layout
 *
 * Wraps all professional services routes: dienstverlening, cases, adviesgesprek.
 * Includes full frontend chrome: Header, Footer, Nav, etc.
 */
export default async function ProfessionalServicesLayout({ children }: { children: ReactNode }) {
