  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4">
        {/* Total Orders - alleen tonen als checkout enabled is */}
        {features.checkout && (
        ...
        {/* Orders In Transit - alleen tonen als checkout EN orderTracking enabled zijn */}
        ...
        {/* Order Lists - alleen tonen als orderLists enabled is */}
        {features.orderLists && (
          <div className="bg-white rounded-xl lg:rounded-2xl p-4 lg:p-5 shadow-sm">
            <div className="flex flex-col gap-2 lg:flex-row lg:items-start lg:justify-between lg:mb-3">
              <div
        ...
        {/* Yearly Spend - alleen tonen als checkout enabled is */}
        {features.checkout && (
          <div className="bg-white rounded-xl lg:rounded-2xl p-4 lg:p-5 shadow-sm">
            <div className="flex flex-col gap-2 lg:flex-row lg:items-start lg:justify-between lg:mb-3">
              <div
      ...
      <div className="bg-white rounded-xl lg:rounded-2xl p-4 lg:p-6 shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 lg:gap-4">
          {/* Herhaalbestelling - alleen tonen als recurringOrders enabled is */}
          {features.recurringOrders && (
            <Link
              href="/my-account/recurring-orders"
      ...
      {/* Recent Orders - alleen tonen als checkout enabled is */}
      {features.checkout && (
        <div className="bg-white rounded-xl lg:rounded-2xl p-4 lg:p-6 shadow-sm">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
        ...
        {/* Addresses - alleen tonen als addresses enabled is */}
        {features.addresses && (
          <div className="bg-white rounded-xl lg:rounded-2xl p-4 lg:p-6 shadow-sm">
            <div className="flex items-center justify-between mb-4 lg:mb-5">
