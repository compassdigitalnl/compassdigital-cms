...
/**
 * Automotive Branch Layout
 *
 * Wraps all automotive routes: occasions, werkplaats, afspraak-maken, inruilen, contact.
 * Includes full frontend chrome: Header, Footer, Nav, etc.
 */
export default async function AutomotiveLayout({ children }: { children: ReactNode }) {
