...
/**
 * Toerisme Branch Layout
 *
 * Wraps all toerisme routes: reizen, accommodaties, boeken, contact.
 * Includes full frontend chrome: Header, Footer, Nav, etc.
 */
export default async function ToerismeLayout({ children }: { children: ReactNode }) {
