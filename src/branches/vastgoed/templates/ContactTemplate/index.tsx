...
/**
 * ContactTemplate - Contact pagina voor vastgoed branch (/contact)
 *
 * Client component met form state.
 * Contactformulier met vastgoed-specifieke onderwerpen.
 * Team members grid (makelaars).
 * Sidebar: openingstijden, contactgegevens, snelle links.
 */

const subjectOptions = [
  { value: 'bezichtiging', label: 'Bezichtiging plannen' },
  { value: 'waardebepaling', label: 'Waardebepaling aanvragen' },
  { value: 'verkoop', label: 'Woning verkopen' },
  { value: 'aankoop', label: 'Hulp bij aankoop' },
  { value: 'hypotheek', label: 'Hypotheek advies' },
      ...
      >
        <div className="mx-auto max-w-7xl px-6 text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-white/80">
            Onze makelaars staan voor u klaar. Neem gerust contact op voor persoonlijk advies over kopen, verkopen of waardebepaling.
          </p>
        </div>
      </section>
