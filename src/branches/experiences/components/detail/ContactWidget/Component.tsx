...
export function ContactWidget({
  ...
  return (
    <div className={`bg-white border border-grey-light rounded-2xl p-5 ${className}`}>
      {/* Header: Avatar + Info */}
      <div className="flex items-center gap-3 mb-3">
        ...
        <div className="min-w-0">
          ...
          <div className="text-xs text-grey-mid">{role}</div>
          {isOnline && (
      ...
      {/* Message Bubble */}
      <div className="bg-grey-light rounded-lg rounded-tl-none px-4 py-3 mb-4">
      ...
      <div className="flex gap-2">
        ...
        {phone && (
          <a
            href={`tel:${phone}`}
            className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-lg text-sm font-semibold text-[var(--color-navy)] border border-grey-light hover:border-[var(--color-teal)] hover:text-[var(--color-teal)] transition-colors"
          >
