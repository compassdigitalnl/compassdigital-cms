  ...
  return (
    <section className={`${className}`} aria-labelledby="content-story-title">
      <h2
        ...
        className="mb-3.5 flex items-center gap-2 font-heading text-xl font-extrabold text-[var(--color-text-primary)]"
      >
      ...
      <div className="rounded-2xl border border-[var(--grey,#E8ECF1)] bg-white p-7">
        <div className="text-[15px] leading-[1.7] text-[var(--color-text-secondary)] [&_p]:mb-2.5 [&_p:last-child]:mb-0">
