  ...
  return (
    <section className="map py-16 px-4">
      <div className="container mx-auto">
        ...
        <div className={`map-container bg-grey-light rounded-lg flex items-center justify-center ${height === 'large' ? 'h-[600px]' : height === 'small' ? 'h-[300px]' : 'h-[450px]'}`}>
          <p className="text-grey-mid">Map: {address}</p>
        </div>
      </div>
    </section>
  )
