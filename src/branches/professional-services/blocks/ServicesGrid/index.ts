...
/**
 * Professional Services Grid Block
 *
 * Grid of professional services pulled from ProfessionalServices collection.
 * Features:
 ...
 *
 * Based on: Construction ServicesGrid block pattern
 */
export const ProfessionalServicesGrid: Block = {
  slug: 'professional-services-grid',
  labels: {
    singular: 'Diensten Grid (Zakelijk)',
    plural: 'Diensten Grids (Zakelijk)',
  },
  interfaceName: 'ProfessionalServicesGridBlock',
  fields: [
    {
      name: 'heading',
      type: 'group',
      ...
      fields: [
        ...
        },
        {
          ...
          required: true,
          label: 'Titel',
          defaultValue: 'Onze zakelijke diensten',
        },
        {
          name: 'description',
          type: 'textarea',
          label: 'Omschrijving',
          defaultValue: 'Van strategisch advies tot uitvoering. Wij ondersteunen uw bedrijf bij elke zakelijke uitdaging.',
          admin: {
            rows: 2,
          },
        },
