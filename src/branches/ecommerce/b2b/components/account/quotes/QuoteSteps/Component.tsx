...
export function QuoteSteps({ steps = DEFAULT_STEPS }: QuoteStepsProps) {
  return (
    <div className="bg-white border rounded-2xl p-6 mb-4" style={{ borderColor: 'var(--color-border)' }}>
      <div className="flex items-center gap-2 mb-4">
        <Zap className="w-4 h-4" style={{ color: 'var(--color-primary)' }} />
        <h3 className="text-sm font-extrabold" style={{ color: 'var(--color-foreground)', fontFamily: 'var(--font-heading)' }}>
          Hoe het werkt
        </h3>
      </div>
