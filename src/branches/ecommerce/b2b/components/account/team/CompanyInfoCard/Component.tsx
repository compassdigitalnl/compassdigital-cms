    ...
    <div className="bg-white rounded-xl lg:rounded-2xl p-4 lg:p-6 shadow-sm">
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-base lg:text-lg font-extrabold text-navy">{company.companyName}</h2>
            <span className="text-xs text-grey-mid">{company.memberCount} teamleden</span>
          </div>
        </div>
        <span
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        {company.kvkNumber && (
          <div className="flex items-center gap-2 text-sm text-grey-dark">
            <Hash className="w-4 h-4 text-grey-mid" />
