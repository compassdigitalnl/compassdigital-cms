...
export default function ApprovalsTemplate({ requests, canApprove }: ApprovalsTemplateProps) {
  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl lg:text-3xl font-extrabold mb-1 lg:mb-2 text-gray-900">Goedkeuringen</h1>
      ...
      {filtered.length === 0 ? (
        <div className="bg-white rounded-xl lg:rounded-2xl p-8 lg:p-12 shadow-sm text-center">
          ...
          <p className="text-sm font-semibold text-gray-500">Geen goedkeuringsverzoeken</p>
