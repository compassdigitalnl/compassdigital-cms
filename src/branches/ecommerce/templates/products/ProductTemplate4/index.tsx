  ...
  return (
    <>
      <div className="product-template-4 overflow-x-hidden pb-20" style={{ maxWidth: 'var(--container-width, 1792px)', margin: '0 auto' }}>
        ...
        <div className="hidden lg:grid lg:grid-cols-2 lg:gap-12 lg:items-start lg:mb-12">
          {/* LEFT: Gallery */}
        ...
        {features.shop && (
          <div className="pt-16 border-t border-t-[var(--color-border)] mt-16 px-4 lg:px-0">
