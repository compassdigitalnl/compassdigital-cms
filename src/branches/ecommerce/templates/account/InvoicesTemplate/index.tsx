...
import { InvoiceStatsBar, InvoiceRow } from '@/branches/ecommerce/components/account/invoices'
...
export default function InvoicesTemplate({
  ...
  return (
    <div className="space-y-4 lg:space-y-6">
      <div>
        <h1 className="text-2xl lg:text-3xl font-extrabold mb-1 lg:mb-2 text-gray-900">Mijn Facturen</h1>
        <p className="text-sm lg:text-base text-gray-500">Bekijk en download je facturen</p>
      </div>
