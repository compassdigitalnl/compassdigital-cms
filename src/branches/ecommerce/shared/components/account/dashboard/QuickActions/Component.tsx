...
export function QuickActions() {
  return (
    <div className="bg-white rounded-xl lg:rounded-2xl p-4 lg:p-6 shadow-sm">
      <h2 className="text-base lg:text-lg font-extrabold mb-3 lg:mb-4 text-navy">
        Snelle acties
      </h2>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 lg:gap-4">
        {features.recurringOrders && (
          ...
          >
            ...
            <div className="flex-1 text-left">
              <div className="text-sm font-bold text-navy mb-0.5">Herhaalbestelling</div>
              <div className="text-xs text-grey-mid">Bestel laatste order opnieuw</div>
            </div>
          </Link>
        )}
        ...
        >
          ...
          <div className="flex-1 text-left">
            <div className="text-sm font-bold text-navy mb-0.5">Offerte aanvragen</div>
            <div className="text-xs text-grey-mid">Voor grote hoeveelheden</div>
          </div>
        </Link>
        ...
        >
          ...
          <div className="flex-1 text-left">
            <div className="text-sm font-bold text-navy mb-0.5">Klantenservice</div>
            <div className="text-xs text-grey-mid">Chat of bel ons</div>
          </div>
        </Link>
      </div>
    </div>
