    ...
    <div className="bg-white rounded-xl lg:rounded-2xl p-4 lg:p-6 shadow-sm lg:sticky lg:top-8">
      ...
      <div className="space-y-2 lg:space-y-3 mb-4">
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs lg:text-sm font-semibold text-gray-900">€{formatPriceStr(order.subtotal)}</span>
        </div>
        <div className="flex items-center justify-between">
        ...
        <div className="flex items-center justify-between">
          <span className="text-xs lg:text-sm text-gray-500">BTW</span>
          <span className="text-xs lg:text-sm font-semibold text-gray-900">€{formatPriceStr(order.tax)}</span>
        </div>
      </div>

      <div className="flex items-center justify-between pt-3 lg:pt-4 mb-4 lg:mb-5 border-t-2 border-gray-200">
        <span className="text-base lg:text-lg font-extrabold text-gray-900">Totaal ({vatLabel})</span>
