    ...
    <div className="p-4">
      <div className="flex items-start justify-between mb-2">
        <div className="flex-1 min-w-0">
          <span className="text-xs font-bold text-navy font-mono block mb-0.5">{order.orderNumber}</span>
        ...
        <span className="text-base font-bold text-navy flex-shrink-0 ml-2">€{formatPriceStr(order.total)}</span>
      </div>
