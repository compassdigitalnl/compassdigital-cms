  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 lg:gap-4">
        <div className="w-10 h-10 lg:w-12 lg:h-12 rounded-lg lg:rounded-xl flex items-center justify-center flex-shrink-0 bg-teal-50">
        ...
        <ChevronRight className="w-4 h-4 lg:w-5 lg:h-5 text-teal flex-shrink-0" />
      </div>
    </a>
  )
}
