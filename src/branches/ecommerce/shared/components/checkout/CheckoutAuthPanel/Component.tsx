...
import { AuthTabSwitcher } from '@/branches/ecommerce/shared/components/auth/AuthTabSwitcher'
import type { TabId } from '@/branches/ecommerce/shared/components/auth/AuthTabSwitcher'
import { LoginForm } from '@/branches/ecommerce/shared/components/auth/LoginForm'
import { GuestCheckoutForm } from '@/branches/ecommerce/shared/components/auth/GuestCheckoutForm'
import { OAuthButtons } from '@/branches/ecommerce/shared/components/auth/OAuthButtons'
import { TrustBadges } from '@/branches/ecommerce/shared/components/auth/TrustBadges'
import { FormInput } from '@/branches/ecommerce/shared/components/auth/FormInput'
import type { KvkResult } from '@/branches/ecommerce/b2b/components/auth/KvkLookup'
import { PasswordStrengthMeter } from '@/branches/ecommerce/shared/components/auth/PasswordStrengthMeter'

const KvkLookup = dynamic(
  () => import('@/branches/ecommerce/b2b/components/auth/KvkLookup').then(m => ({ default: m.KvkLookup })),
  { ssr: false }
)
          ...
          <div className="flex gap-2 mb-6">
            <button
              ...
              className={`
                ...
                ${registerMode === 'b2c'
                  ? 'border-[var(--color-primary)] bg-[rgba(10,22,40,0.05)] text-[var(--color-primary)]'
                ...
                <button
                  ...
                  style={{
                    background: b2cLoading
                      ...
                      : 'var(--color-primary)',
                    boxShadow: b2cLoading ? 'none' : '0 4px 16px var(--color-primary-glow)',
                  }}
                >
                ...
                <button
                  ...
                  style={{
                    background: b2bLoading
                      ? 'var(--color-text-secondary)'
                      : 'var(--color-primary)',
                    boxShadow: b2bLoading ? 'none' : '0 4px 16px var(--color-primary-glow)',
                  }}
                >
