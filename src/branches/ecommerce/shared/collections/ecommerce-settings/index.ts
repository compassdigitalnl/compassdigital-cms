  ...
  fields: [
    {
      ...
      tabs: [
          ...
          fields: [
            {
              ...
              fields: [
                // ── SHOP FEATURES ──
                {
                  ...
                  fields: [
                    { name: 'enableReviews', type: 'checkbox', label: 'Product Reviews', defaultValue: false, admin: { description: 'Klanten kunnen producten reviewen en beoordelen' } },
                    { name: 'enableWishlist', type: 'checkbox', label: 'Verlanglijstje', defaultValue: false },
                    { name: 'enablePromotions', type: 'checkbox', label: 'Promoties & Kortingscodes', defaultValue: true },
                    { name: 'enableRecentlyViewed', type: 'checkbox', label: 'Recent Bekeken', defaultValue: false },
                  ],
                },
                ...
                // ── ACCOUNT FEATURES ──
                {
                  ...
                  fields: [
                    { name: 'enableReturns', type: 'checkbox', label: 'Retouren', defaultValue: false },
                    { name: 'enableOrderLists', type: 'checkbox', label: 'Bestellijsten', defaultValue: false },
                    { name: 'enableRecurringOrders', type: 'checkbox', label: 'Herhalingsbestellingen', defaultValue: false },
                    { name: 'enableQuickOrder', type: 'checkbox', label: 'Quick Order (bulk)', defaultValue: false },
                    { name: 'enableNotifications', type: 'checkbox', label: 'Notificaties', defaultValue: false },
                    { name: 'enableStockNotifications', type: 'checkbox', label: 'Voorraad Notificaties', defaultValue: false },
                  ],
                },
                ...
                // ── EXTRA MODULES ──
                {
                  ...
                  admin: { initCollapsed: true },
                  fields: [
                    { name: 'enableLoyalty', type: 'checkbox', label: 'Loyaliteitsprogramma', defaultValue: false, admin: { description: 'Punten, tiers, beloningen' } },
                    { name: 'enableSubscriptions', type: 'checkbox', label: 'Abonnementen', defaultValue: false },
                    { name: 'enableGiftVouchers', type: 'checkbox', label: 'Cadeaubonnen', defaultValue: false },
                    { name: 'enableLicenses', type: 'checkbox', label: 'Licenties & Activaties', defaultValue: false },
                  ],
                },
              ],
            },
        ...
        ...featureTab('b2b', {
          ...
          description: 'B2B specifieke instellingen en features',
          fields: [
            {
              name: 'b2bFeatures',
              type: 'group',
              label: 'B2B Features',
              fields: [
                { name: 'enableCustomerGroups', type: 'checkbox', label: 'Klantgroepen & Groepsprijzen', defaultValue: false, admin: { description: 'Klantgroepen met specifieke prijzen en kortingen' } },
                { name: 'enableCompanyAccounts', type: 'checkbox', label: 'Bedrijfsaccounts & Teams', defaultValue: false, admin: { description: 'Bedrijfsaccounts met uitnodigingen en teamleden' } },
                { name: 'enableApprovalWorkflow', type: 'checkbox', label: 'Goedkeuringsworkflow', defaultValue: false, admin: { description: 'Bestellingen moeten goedgekeurd worden door manager' } },
                { name: 'enableQuotes', type: 'checkbox', label: 'Offertes', defaultValue: false, admin: { description: 'Klanten kunnen offertes aanvragen' } },
              ],
            },
            {
