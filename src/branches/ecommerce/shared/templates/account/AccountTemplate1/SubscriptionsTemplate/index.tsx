...
import {
  ...
  UsageMeters,
  BillingHistory,
} from '@/branches/ecommerce/shared/components/account/subscriptions'
  ...
  return (
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-grey-dark">Beheer je abonnement, gebruik en facturatie</p>
      </div>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          {subscription.addons.map((addon, index) => (
            <div
              key={index}
              className="bg-white border border-grey-light rounded-lg p-4 flex items-center gap-3"
            >
          ...
          <button
            onClick={onAddAddon}
            className="btn btn-ghost border-2 border-dashed border-grey-light p-4 flex items-center justify-center gap-2"
          >
            + Add-on toevoegen
          </button>
        </div>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          ...
          >
            <div className="w-11 h-8 bg-grey-light rounded flex items-center justify-center text-xs font-bold flex-shrink-0">
            ...
            <div className="flex-1">
              ...
              <div className="text-xs text-grey-mid">Verloopt 12/2027</div>
            </div>
            {subscription.paymentMethod.isDefault && (
          ...
          <button
            ...
            className="btn btn-ghost border border-grey-light p-4 flex items-center justify-center gap-2"
          >
      ...
      {/* Cancel Subscription */}
      <div className="bg-white border border-grey-light rounded-lg p-4 flex items-center gap-3">
