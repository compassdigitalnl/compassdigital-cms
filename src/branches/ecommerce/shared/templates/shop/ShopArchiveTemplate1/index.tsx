...
import { useShopSearch, type ShopSearchHit } from '@/branches/ecommerce/shared/hooks/useShopSearch'
import {
  facetsToFilterGroups,
  searchStateToActiveFilters,
  activeFiltersToSearchUpdates,
} from '@/branches/ecommerce/shared/lib/shop/facetsToFilters'

// Types & Utils
import type { BreadcrumbItem } from '@/globals/site/breadcrumbs/components/Breadcrumbs'

// Modern Components
import { CategoryHero } from '@/branches/ecommerce/shared/components/shop/CategoryHero/CategoryHero'
import { Breadcrumbs } from '@/globals/site/breadcrumbs/components/Breadcrumbs'
import { SubcategoryChips, type SubcategoryChip } from '@/branches/ecommerce/shared/components/shop/SubcategoryChips/Component'
import { FilterSidebar } from '@/branches/ecommerce/shared/components/shop/FilterSidebar/FilterSidebar'
import { MobileFilterDrawer } from '@/branches/ecommerce/shared/components/shop/FilterSidebar/MobileFilterDrawer'
import { ShopToolbar } from '@/branches/ecommerce/shared/components/shop/SortDropdown/ShopToolbar'
...
const QuickViewModal = dynamic(
  () => import('@/branches/ecommerce/b2c/components/products/QuickViewModal').then(m => ({ default: m.QuickViewModal })),
  { ssr: false }
)
...
import type { SortOption, ViewMode } from '@/branches/ecommerce/shared/components/shop/SortDropdown/types'
