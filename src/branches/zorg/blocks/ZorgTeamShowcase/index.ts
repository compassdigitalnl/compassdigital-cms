...
export const ZorgTeamShowcase: Block = {
  slug: 'zorg-team-showcase',
  labels: {
    singular: 'Zorg Team Showcase',
    plural: 'Zorg Team Showcases',
  },
  interfaceName: 'ZorgTeamShowcaseBlock',
  fields: [
    {
      name: 'heading',
      type: 'group',
    ...
    },
    {
      ...
      type: 'checkbox',
      label: 'Toon specialisaties',
      defaultValue: true,
    },
  ],
}

export default ZorgTeamShowcase
