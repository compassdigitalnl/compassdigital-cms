...
import { OpeningHours } from '@/branches/horeca/components/OpeningHours'
    ...
    <div style={{ backgroundColor: 'var(--color-bg, #ffffff)' }}>
      ...
      <div className="mx-auto max-w-7xl px-6 pb-6">
        ...
        <p className="mt-2 text-lg" style={{ color: 'var(--color-grey-dark, #475569)' }}>
          Heeft u een vraag of wilt u een reservering plaatsen? Neem gerust contact met ons op.
        </p>
      </div>
                  ...
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="groepsaanvraag">Groepsaanvraag</option>
