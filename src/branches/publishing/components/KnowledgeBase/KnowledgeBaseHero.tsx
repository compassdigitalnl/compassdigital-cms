    ...
    <div className="relative bg-gradient-to-br from-primary/5 via-primary/10 to-primary/5 dark:from-primary/10 dark:via-primary/20 dark:to-primary/10 py-16 sm:py-20">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-xl text-grey-dark dark:text-grey-mid max-w-3xl mx-auto">
        ...
        <div className="max-w-2xl mx-auto mb-10">
          <div className="relative">
            <Search className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-grey-mid" />
            <Input
              type="search"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
          {/* Total Articles */}
          <div className="bg-white dark:bg-navy rounded-xl p-6 shadow-md text-center">
            ...
            <div className="text-sm text-grey-dark dark:text-grey-mid">Artikelen</div>
          </div>
          ...
          <div className="bg-white dark:bg-navy rounded-xl p-6 shadow-md text-center">
            ...
            <div className="text-sm text-grey-dark dark:text-grey-mid">Pro Content</div>
          </div>

          {/* Total Reading Time */}
          {totalReadingTime && (
            <div className="bg-white dark:bg-navy rounded-xl p-6 shadow-md text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-teal/10 text-teal mb-3">
                <Clock className="w-6 h-6" />
              </div>
              <div className="text-3xl font-bold text-navy dark:text-white mb-1">
                {Math.round(totalReadingTime / 60)}h
              </div>
              <div className="text-sm text-grey-dark dark:text-grey-mid">Leestijd</div>
            </div>
          )}
        </div>
      </div>
