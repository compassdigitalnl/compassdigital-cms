...
import { RenderBlogContent } from '@/branches/shared/components/content/RenderBlogContent'
  ...
  if (isLoading) {
    return (
      <div className={`animate-pulse space-y-4 ${className}`}>
        <div className="h-4 bg-grey-light dark:bg-navy rounded w-3/4" />
        <div className="h-4 bg-grey-light dark:bg-navy rounded w-full" />
        <div className="h-4 bg-grey-light dark:bg-navy rounded w-5/6" />
      </div>
    )
  }
